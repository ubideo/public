...
Persons are obliged to use the full Service as is whereas legal entities (companies) are not obliged to use the full Service as is. To use the full Service, legal entities should contact Ubideo B.V.
